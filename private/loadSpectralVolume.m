...
meta = struct( ...
    ...
    'currentIntegrationMode', 'sum(abs(timeDomain),1)', ...
    'currentSpectralValueMode', 'abs', ...
    'currentSpectralRange', [], ...
    'spectralAxisUsePpm', false, ...
    'spectralSWPpm', max(1, double(nSpecPoints) - 1), ...
    'spectralO1Ppm', 0, ...
    'phaseEnabled', false, ...
    'phaseMode', 'global', ...
    'phaseMaps', [], ...
    'phaseParams', struct('ph0Deg', 0, 'ph1Deg', 0, 'pivotIndex', round(nSpecPoints / 2)));
end
